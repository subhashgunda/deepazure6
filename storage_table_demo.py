...
resourcegroup_name = 'gsr'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'gsr'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
# Here, we add an entry for first cars with five pieces of data - the make, model, year, color and price
#
...
cars = Entity()
cars.PartitionKey = 'carsinventory'
cars.RowKey = '001'
cars.make = 'Honda'
cars.model = 'CRV'
cars.year = '2017'
...
cars.price = '300000'
table_service.insert_entity('itemstable', cars)
print('Created entry for Ferrari...')
...
cars.price = 60000
table_service.insert_entity('itemstable', cars)
print('Created entry for Infiniti...\n')
...
coffee.RowKey = '005'
coffee.brand = 'startbucks'
coffee.flavor = 'mocha'
coffee.size = 'large'
coffee.price = 5.10
table_service.insert_entity('itemstable', coffee)
print('Created entry for a startbucks...\n')
time.sleep(1)

coffee = Entity()
coffee.PartitionKey = 'coffeeshop'
coffee.RowKey = '006'
coffee.brand = 'barista'
coffee.flavor = 'latte'
coffee.size = 'large'
coffee.price = 4.05
table_service.insert_entity('itemstable', coffee)
print('Created entry for barista...\n')
time.sleep(1)
